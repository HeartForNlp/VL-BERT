...
from simplevg.data.datasets import *
from simplevg.data import samplers
from simplevg.data.transforms.build import build_transforms
from simplevg.data.collate_batch import BatchCollator
import pprint

DATASET_CATALOGS = {'simplevg': SimpleVGDataset}
...
def make_dataloader(cfg, dataset=None, mode='train', distributed=False, num_replicas=None, rank=None,
    ...
    if dataset is None:
        ...
        dataset = build_dataset(dataset_name=cfg.DATASET.DATASET, captions_set=captions_set,
                                roi_set=cfg.DATASET.ROI_SET, image_set=cfg.DATASET.IMAGE_SET,
