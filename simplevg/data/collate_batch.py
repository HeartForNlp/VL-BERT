...
class BatchCollator(object):
    ...
    def __call__(self, batch):
        ...
        max_caption_length = max([len(data[self.data_names.index('caption')]) for data in batch])
        ...
        for i, ibatch in enumerate(batch):
            ...
            caption = ibatch[self.data_names.index('caption')]
            out['caption'] = clip_pad_2d(caption, (max_caption_length, len(caption[0])), pad=0)
