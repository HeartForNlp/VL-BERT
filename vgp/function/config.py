...
_C.NETWORK.SUPERVISE_ATTENTION = ""
_C.NETWORK.ATTENTION_LOSS_WEIGHT = 1.0
_C.NETWORK.ATTENTION_NORM_METHOD = 'linear'
_C.NETWORK.EWC_REG = False
_C.NETWORK.FISHER_PATH = ''
...
_C.NETWORK.VG = edict()
_C.NETWORK.VG.CLASSIFIER_TYPE = "2fc"    # 2fc or 1fc
_C.NETWORK.VG.CLASSIFIER_HIDDEN_SIZE = 1024
_C.NETWORK.VG.CLASSIFIER_DROPOUT = 0.1
